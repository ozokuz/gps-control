float myLat0 = 60.133470206254394, myLon0 = 24.942398071289066; //Last location
...
//target coordinates
float WaypointLat[] = {60.146119427630715, 60.139282614706985, 61.458058446922635, 60.12859724911918, 60.121842308255474, 60.130563616914216, 60.14372670476474, 60.14825564022888};
float WaypointLong[] = {24.9580192565918, 24.97346878051758, 24.97346878051758, 24.97638702392578, 24.941368103027347, 24.911155700683597, 24.927120208740238, 24.93947982788086};
...
void loop() {
  ...
  Serial.print(" my cordinates:"); Serial.print(myLat1, 6); Serial.print(", "); Serial.print(myLon1, 6);
  Serial.print(" headingNow "); Serial.print(headingNow);
  Serial.print(" targetBearingNow "); Serial.print(targetBearingNow);
  Serial.print(" headingChange "); Serial.println(headingChange);
